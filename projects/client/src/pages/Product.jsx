...
function Product() {
  ...
  const getProduct = async () => {
    try {
      let res = await axios.get(
        `${API_URL}/product/?page=${page}&size=${size}&sortby=${sortby}&order=${order}&name=${name}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      return (
        <Tr textColor={"white"}>
          ...
          <Td>
            {
              <Image
                h={"auto"}
                width={"75px"}
                src={`${API_IMG_URL}${val.productImage}`}
              />
            }
          </Td>
          <Td>{val.name}</Td>
          ...
          <Td>
            {val.types.length == 0
              ? `-`
              : formating(val?.types[0].price) +
                " - " +
                formating(val?.types[val?.types.length - 1].price)}
          </Td>
  ...
  const getAllWarehouse = async () => {
    try {
      if (roleId == 1) {
        ...
        let res = await axios.get(
          `${API_URL}/warehouse/all-warehouse?warehouseId=${warehouseId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const onBtnEdit = async (id, productImage, name, categoryId, description) => {
    try {
      modalEdit.onOpen();
      ...
      if (roleId == 1) {
        ...
        let res = await axios.get(
          `${API_URL}/product/variant?id=${id}&warehouseId=${warehouseId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const editVariant = async () => {
    try {
      let res = await axios.patch(
        `${API_URL}/product/variant/${activeIndex.id}`,
        {
        ...
        <Box my={"20px"} textColor="white">
          ...
          >
            ...
            <ModalContent>
                              ...
                              <Td>
                                {
                                  <CreatableSelect
                                    ...
                                    isLoading={isLoading}
                                    onChange={(newValue) =>
                                      handleVariationChangeColor(idx, newValue)
                                    }
                              ...
                              <Td>
                                {
                                  <CreatableSelect
                                    ...
                                    isLoading={isLoading}
                                    onChange={(newValue) =>
                                      handleVariationChangeMemory(idx, newValue)
                                    }
                              ...
                              <Td>
                                {
                                  <Select
                                    ...
                                    variant={"filled"}
                                    onChange={(e) =>
                                      handleVariationChangeWarehouse(
                                        idx,
                                        e.target.value
                                      )
                                    }
              ...
              <ModalFooter>
                <Button colorScheme="blue" mr={3} onClick={btnSaveAddProduct}>
                  Save
                </Button>
                  ...
                  <Box w={"18%"}>
                    ...
                    <FormControl mt={2}>
                      ...
                      <Image
                        src={
                          fileProductEditNew
                            ? URL.createObjectURL(fileProductEditNew)
                            : `${API_IMG_URL}${fileProductEdit}`
                        }
                        style={{
                          width: "80px",
                          height: "80px",
                              ...
                              <Td>
                                {
                                  <CreatableSelect
                                    ...
                                    isLoading={isLoading}
                                    onChange={(newValue) =>
                                      handleVariationChangeColorEdit(
                                        idx,
                                        newValue
                                      )
                                    }
                                    ...
                                    options={optionsColor}
                                    defaultInputValue={() => {
                                      let value = optionsColor.filter(
                                        (val) =>
                                          variationEdit.colorId == val.value
                                      );
                                      if (value.length) {
                              ...
                              <Td>
                                {
                                  <CreatableSelect
                                    ...
                                    isLoading={isLoading}
                                    onChange={(newValue) =>
                                      handleVariationChangeMemoryEdit(
                                        idx,
                                        newValue
                                      )
                                    }
                                    ...
                                    options={optionsMemory}
                                    defaultInputValue={() => {
                                      let value = optionsMemory.filter(
                                        (val) =>
                                          variationEdit.memoryId == val.value
                                      );
                                      if (value.length) {
                                        return value[0].label;
                                      } else {
                              ...
                              <Td>
                                {
                                  <Input
                                    ...
                                    variant={"filled"}
                                    onChange={(e) =>
                                      handleVariationChangePriceEdit(
                                        idx,
                                        e.target.value
                                      )
                                    }
                              ...
                              <Td>
                                {
                                  <Input
                                    ...
                                    variant={"filled"}
                                    onChange={(e) =>
                                      handleVariationChangeDiscountEdit(
                                        idx,
                                        e.target.value
                                      )
                                    }
                              ...
                              <Td>
                                {
                                  <Select
                                    ...
                                    variant={"filled"}
                                    onChange={(e) =>
                                      handleVariationChangeWarehouseEdit(
                                        idx,
                                        e.target.value
                                      )
                                    }
                              ...
                              <Td>
                                {
                                  <Input
                                    ...
                                    variant={"filled"}
                                    onChange={(e) =>
                                      handleVariationChangeStockEdit(
                                        idx,
                                        e.target.value
                                      )
                                    }
