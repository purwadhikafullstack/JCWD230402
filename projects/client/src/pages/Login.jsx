            ...
            <div className='flex flex-col gap-3'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex hover:scale-105 duration-300'>
                        ...
                        <button className='bg-transparent h-[26px] px-1 text-xl rounded-tr-xl rounded-br-xl border border-emerald-300 text-[#1BFD9C]' type='button' onClick={klik}> {visible ? <HiEye /> : <HiEyeOff />}</button>
                    </div>
                </div>
