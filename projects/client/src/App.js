...
import { Home, Register, RequestPassword, ResetPassword, Verification, Login, Dashboard, AdminLogin, PageNotFound } from './pages';
...
function App() {
  ...
  useEffect(() => { keepLogin(); adminkeepLogin() }, [])

  return (
    <AnimatePresence>
      <div className=' w-screen h-auto flex flex-col bg-zinc-900' >

        {roleId ? (<main className='mt-2 md:mt-2 px-4 md:px-16 w-full'>
          <Routes>
