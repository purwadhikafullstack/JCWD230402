...
route.post("/", readToken, uploader("/ImgProduct", "PRO").array("images", 1), productController.addProduct); //images itu harus sama dengan yang di formData FE
...
route.patch("/", readToken, uploader("/ImgProduct", "PRO").array("images", 1), productController.editProduct);
